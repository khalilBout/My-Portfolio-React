...
import img4 from "../../assets/images/Projects/img1.png";
import img5 from "../../assets/images/Projects/img3.png";
  ...
  return (
    ...
    >
      <div className="flex gap-4 max-sml:flex-col ">
        ...
        <div className="w-full max-md:max-w-[300px] flex">
          {/* <Slider {...settings}> */}
          ...
          {filterDishes.map((dishes) => {
            ...
            return <CartProject key={dishes.id} dishes={dishes} />;
          })}
          {/* </Slider> */}
        </div>
      </div>
